...
| 🌿 **수상** | ESG 캡스톤디자인 페어 **우수상** |
| 📄 **특허** | 고령자를 위한 일대일 모바일 관리 및 데이터 처리 방법 (출원번호: APE20230445) · [📎 출원서 보기](./assets/어르신을부탁해특허.pdf) |
| 📝 **논문** | One-to-one mobile care system for the elderly (학술대회 발표) · [📎 논문 보기](./assets/어르신을%20부탁해%20논문.pdf) |
