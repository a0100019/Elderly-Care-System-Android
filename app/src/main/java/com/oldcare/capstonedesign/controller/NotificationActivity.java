...
import com.oldcare.capstonedesign.databinding.ActivityNotificationBinding;
...
public class NotificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.memoTitleTextView.setText(title);
    ...
    private void yesButton(String title) {
        binding.medicineYesButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                String content = binding.memoTextInputEditText.getText().toString();
                ...
                builder.setTitle("시간을 설정해주세요")
                        ...
                        .setPositiveButton("확인", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                binding.timeButton.setText(time);
                            }
                        })
