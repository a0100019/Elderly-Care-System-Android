...
nimport com.oldcare.capstonedesign.network.KakaoAPI_search;
import com.oldcare.capstonedesign.network.KakaoApiResponse_search;
...
import com.oldcare.capstonedesign.databinding.ActivitySetSafetyZoneBinding;
...
public class SetSafetyZoneActivity extends AppCompatActivity {
    private ActivitySetSafetyZoneBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivitySetSafetyZoneBinding.inflate(getLayoutInflater());
        ...
        binding.searchbutton.setOnClickListener(view -> {
            String searchText = binding.editTextText.getText().toString();
            if (TextUtils.isEmpty(searchText)) showToast("도로명 주소를 입력해주세요");
            else doSearch(searchText);
        });

        binding.distInsert.setOnClickListener(view -> {
            String distString = binding.editTextNumber.getText().toString().trim(); // 문자열 앞뒤 공백 제거
        ...
        binding.setzone.setOnClickListener(view -> {
        ...
        binding.okbutton.setOnClickListener(view -> okbutton());

        binding.resetzone.setOnClickListener(view -> resetzone());
