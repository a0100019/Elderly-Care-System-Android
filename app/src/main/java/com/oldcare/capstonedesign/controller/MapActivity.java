...
import com.oldcare.capstonedesign.model.LocationData;
import com.oldcare.capstonedesign.network.KaKaoAPI_Address;
import com.oldcare.capstonedesign.network.KaKaoAPI_Category;
import com.oldcare.capstonedesign.network.KakaoAPI_geocoder;
import com.oldcare.capstonedesign.network.KakaoApiResponse_Address;
import com.oldcare.capstonedesign.network.KakaoApiResponse_Category;
import com.oldcare.capstonedesign.network.KakaoApiResponse_geocoder;
import com.oldcare.capstonedesign.view.MyMapViewEventListener;
import com.oldcare.capstonedesign.view.MyPOIItemEventListener;
...
import com.oldcare.capstonedesign.databinding.ActivityMapBinding;
...
public class MapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.nearcenter.setOnClickListener(view -> showcenter(agencyList,HPList));

        binding.centerList.setOnClickListener(view -> movecenterlist(agencyList,HPList));

        binding.setsafetyzone.setOnClickListener(view -> movesetsaftyzone());

        binding.checkPath.setOnClickListener(view -> getpath());
        ...
        getlatestlocation(() -> {
            ...
            binding.locationtext.setOnClickListener(this::onTextViewClick);
        });
    ...
    protected void onResume() {
        ...
        getlatestlocation(() -> {
            ...
            binding.locationtext.setOnClickListener(v -> onTextViewClick(v));
        });
    }
        ...
        call.enqueue(new Callback<KakaoApiResponse_Address>(){
            ...
            public void onResponse(@NonNull Call<KakaoApiResponse_Address> call, @NonNull Response<KakaoApiResponse_Address> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    binding.locationtext.setText(currentlocation);
                }
            }
            @Override
